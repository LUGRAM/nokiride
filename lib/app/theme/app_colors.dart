...
class AppColors {
  ...
  // Verts profonds (Ajustés pour un look "Slate Green" plus sophistiqué)
  static const Color darkGreenBase    = Color(0xFF0E1212); // Fond Dark (Charcoal très sombre)
  static const Color darkGreenSurface = Color(0xFF1C2524); // Cartes Dark (Slate Green désaturé)
  static const Color emeraldPrimary   = Color(0xFF1f9b61); // Couleur de marque
  ...
  // ════════════════════════════════════════════════
  // DARK THEME (Premium Organic - Slate Edition)
  // ════════════════════════════════════════════════
  static const Color bgDark         = darkGreenBase;
  static const Color bgDarkSurface  = darkGreenSurface;
  static const Color bgDarkElevated = Color(0xFF263331);
  ...
  // ════════════════════════════════════════════════
  // LIGHT THEME (Clean Slate Edition)
  // ════════════════════════════════════════════════
  static const Color bgLight          = Color(0xFFF8FAF9); // Blanc cassé neutre
  static const Color bgLightSurface   = Color(0xFFEEF2F1); // Slate off-white (Froid)
  static const Color bgLightInput     = Color(0xFFE9EFEE);
  static const Color borderLight      = Color(0xFFE2E8E7);

  static const Color textLightPrimary = Color(0xFF1D2120); // Anthracite neutre
  static const Color textLightSub     = Color(0xFF454D4C);
