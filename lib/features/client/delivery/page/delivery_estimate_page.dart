      ...
      child: Column(
        children: [
          ...
          Text(
            d.parcelSize.label,
            style: TextStyle(
                fontSize: 14, fontWeight: FontWeight.w600, color: subC),
          ),
          ...
          Row(
            ...
            children: [
              _Chip(
                  ...
                  label: d.formattedDistance,
                  isDark: isDark),
              const SizedBox(width: 10),
              _Chip(
                  icon: Icons.timer_outlined,
                  label: d.formattedDuration,
                  isDark: isDark),
            ],
          ),
        ],
      ...
      child: Column(
        children: [
          ...
          _RouteRow(
            ...
            label: d.dropoff.name,
            sub: d.dropoff.address,
            titleC: titleC,
            subC: subC,
          ),
        ],
            ...
            child: Column(
              ...
              children: [
                Text(
                  d.recipient.name,
                  style: TextStyle(
                      fontSize: 14, fontWeight: FontWeight.w700, color: titleC),
                ),
...
class _TarifInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color =
        isDark ? AppColors.primaryBlueLight : AppColors.accentBlueLight;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Obx(() {
            final method =
                paymentMethodByValue(controller.selectedPaymentMethod.value);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isDark
                      ...
                      : AppColors.bgLightInput,
                  borderRadius: BorderRadius.circular(14),
                  border: Border.all(color: border),
                ),
                child: Row(children: [
                  Icon(method.icon, color: primary, size: 17),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Text(
                      method.label,
