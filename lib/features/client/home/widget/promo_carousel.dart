...
class _PromoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgBase = isDark
        ? Color.alphaBlend(
            frame.accentColor.withOpacity(.13), AppColors.surface(context))
          ...
          child: ClipRRect(
            ...
            child: Stack(
              ...
              children: [
                ...
                if (frame.hasImage) _GradientOverlay(color: bgBase),
                Positioned(
                  left: 18,
                  top: 14,
                  bottom: 14,
  ...
  Widget _resolveImage(BuildContext context) {
    if (frame.imageAsset != null) {
      return Image(
        ...
        errorBuilder: (_, __, ___) => frame.imageUrl != null
...
class _GradientOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final stops =
        isDark ? const [0.0, 0.50, 0.72, 1.0] : const [0.0, 0.45, 0.68, 1.0];
    final colors = isDark
        ? [
            opaqueColor,
            opaqueColor,
            opaqueColor.withOpacity(.55),
            Colors.transparent
          ]
        : [
            opaqueColor,
            opaqueColor,
            opaqueColor.withOpacity(.80),
            Colors.transparent
          ];
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: frame.accentColor.withOpacity(.22), width: 1),
        ),
...
class _DotsIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final inactiveC =
        isDark ? Colors.white.withOpacity(.18) : Colors.black.withOpacity(.12);
