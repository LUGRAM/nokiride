...
class AppTheme {
  ...
  static ThemeData get dark {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder:       _inputBorder(AppColors.primaryBlue),
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor:     AppColors.bgDarkNav,
  ...
  static TextTheme _buildTextTheme(Color primary, Color secondary) {
    return GoogleFonts.interTextTheme().copyWith(
      displayLarge:  _ts(32, FontWeight.w800, primary),
      displayMedium: _ts(28, FontWeight.w800, primary),
      headlineLarge: _ts(24, FontWeight.w700, primary),
      headlineMedium:_ts(20, FontWeight.w700, primary),
      headlineSmall: _ts(18, FontWeight.w700, primary),
      titleLarge:    _ts(17, FontWeight.w700, primary),
      titleMedium:   _ts(15, FontWeight.w600, primary),
      titleSmall:    _ts(13, FontWeight.w600, primary),
      ...
      labelLarge:    _ts(14, FontWeight.w700, primary),
      labelMedium:   _ts(12, FontWeight.w600, primary),
      labelSmall:    _ts(11, FontWeight.w600, secondary),
    );
  }

  static TextStyle _ts(double size, FontWeight w, Color c) =>
      TextStyle(fontSize: size, fontWeight: w, color: c, letterSpacing: -0.2);
