  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.dialog(AlertDialog(
        ...
        content: const Text('Votre position et celle du colis seront partagées.'),
        actions: [
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: AppColors.error.withOpacity(.40), blurRadius: 12, offset: const Offset(0, 4))],
        ),
        child: const Center(
          child: Text('SOS', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w800)),
        ),
      ),
    );
  }
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text('Marc-Aurèle N.', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: titleC)),
                    Text('Honda XR125 • LBV-3315-B', style: TextStyle(fontSize: 12.5, color: subC)),
                  ],
                ),
              ),
              Column(
                children: [
                  ...
                  Text('4.9', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: titleC)),
                ],
              ),
            ],
          ),
